      ...
      if (null !== t) {
        if ((p++, 1 === t.nodeType)) {
          ...
          if (e.indexOf(s) >= 0) {
            ...
            "" === r[a] ? (s.insertBefore(l(), t), i.push(t)) : (t.data = r[a]),
              (c += a);
          }
        } else if (8 === t.nodeType)
          if (t.data === s) {
            const e = t.parentNode;
            (null !== t.previousSibling && p !== h) ||
              (p++, e.insertBefore(l(), t)),
              (h = p),
              this.parts.push({ type: "node", index: p }),
              null === t.nextSibling ? (t.data = "") : (i.push(t), p--),
              c++;
          } else {
            let e = -1;
  ...
  for (; n.nextNode(); ) {
    ...
    for (
      t.previousSibling === h && (h = null),
        e.has(t) && (d.push(t), null === h && (h = t)),
        null !== h && l++;
      void 0 !== o && o.index === a;

    )
      (o.index = null !== h ? -1 : o.index - l), (r = c(i, r)), (o = i[r]);
  }
    ...
    for (; o < i.length; )
      if (((r = i[o]), a(r))) {
        for (; l < r.index; )
          l++,
            "TEMPLATE" === d.nodeName &&
              (s.push(d), (n.currentNode = d.content)),
            null === (d = n.nextNode()) &&
              ((n.currentNode = s.pop()), (d = n.nextNode()));
        if ("node" === r.type) {
...
class x {
  ...
  _getValue() {
    ...
    for (let n = 0; n < e; n++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (S(t) || !b(t)) i += "string" == typeof t ? t : String(t);
...
const U = (t) =>
  t &&
  (A ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(class {
  handleAttributeExpressions(t, e, s, i) {
    ...
    if ("?" === n) return [new N(t, e.slice(1), s)];
...
const L = {
  ...
  W = (t, e) => e !== t && (e == e || t == t),
  H = { attribute: !0, type: String, converter: L, reflect: !1, hasChanged: W };
class D extends HTMLElement {
  ...
  static getPropertyOptions(t) {
    return (this._classProperties && this._classProperties.get(t)) || H;
  }
  static finalize() {
  ...
  static _propertyValueToAttribute(t, e) {
    ...
    const s = e.type,
      i = e.converter;
    return ((i && i.toAttribute) || L.toAttribute)(t, s);
  }
  initialize() {
    (this._updateState = 0),
  ...
  (tt.render = (t, s, i) => {
    ...
    if (
      (((t, s, i) => {
        ...
        void 0 === n &&
          (e(s, s.firstChild),
          R.set(s, (n = new T(Object.assign({ templateFactory: O }, i)))),
          n.appendInto(s)),
          n.setValue(t),
          n.commit();
      })(t, l, Object.assign({ templateFactory: I(n) }, i)),
      a)
    ) {
      const t = R.get(l);
      R.delete(l);
      const i = t.value instanceof y ? t.value.template : void 0;
      F(n, l, i), e(s, s.firstChild), s.appendChild(l), R.set(s, t);
    }
...
var et = function (t, e, s, i) {
  var n,
    r = arguments.length,
    o =
      r < 3 ? e : null === i ? (i = Object.getOwnPropertyDescriptor(e, s)) : i;
...
let st = class extends tt {
  constructor() {
    super(...arguments),
      (this.swpath = "/ss/ymaldonado/pwabuilder-sw.js"),
  ...
  async firstUpdated() {
    ...
    if (this.swpath && "serviceWorker" in navigator) {
      ...
      if (s.installing && navigator.storage) {
        ...
        if (s) {
          (this.storageUsed = this.formatBytes(s.usage)),
            (this.showOfflineToast = !0),
            ...
            null ===
              (e =
                null === (t = this.shadowRoot) || void 0 === t
                  ? void 0
                  : t.querySelector("#storageToast")) || void 0 === e
              ? void 0
      ...
      s.onupdatefound = async () => {
        let t = s.installing;
        t &&
          (t.onstatechange = () => {
            "installed" === (null == t ? void 0 : t.state) &&
  ...
  setupEvents() {
    this.addEventListener("pwaUpdate", async () => {
      navigator.serviceWorker &&
        ...
        this.swreg && this.swreg.waiting && (this.readyToAsk = !0));
    });
  }
  doUpdate() {
    var t, e;
    null ===
      (e = null === (t = this.swreg) || void 0 === t ? void 0 : t.waiting) ||
      void 0 === e ||
      e.postMessage({ type: this.updateevent }),
  ...
  render() {
    return B`<div>${
      this.readyToAsk
        ? B`<div id="updateToast" part="updateToast"><span>${
            this.updatemessage
          }</span> <button @click="${() =>
            this.doUpdate()}">Update</button></div>`
        : null
    } ${
      this.showOfflineToast
        ? B`<div id="storageToast" part="offlineToast">Ready to use Offline ${
            this.showStorageEstimate
              ? B`<span id="storageEstimate">Cached ${this.storageUsed}</span>`
              : null
          }</div>`
        : null
    }</div>`;
...
var it;
et([G({ type: String })], st.prototype, "swpath", void 0),
  et([G({ type: String })], st.prototype, "updateevent", void 0),
  et([G({ type: String })], st.prototype, "updatemessage", void 0),
  et([G({ type: Boolean })], st.prototype, "readyToAsk", void 0),
  et([G({ type: Boolean })], st.prototype, "showStorageEstimate", void 0),
  et([G({ type: Boolean })], st.prototype, "showOfflineToast", void 0),
  et([G({ type: Number })], st.prototype, "offlineToastDuration", void 0),
  et([G({ type: String })], st.prototype, "storageUsed", void 0),
  (st = et(
    [
      ((it = "pwa-update"),
      (t) =>
        "function" == typeof t
          ? ((t, e) => (window.customElements.define(t, e), e))(it, t)
          : ((t, e) => {
